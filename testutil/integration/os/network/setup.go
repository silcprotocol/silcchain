...
type genSetupFn func(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, _ interface{}) (cosmosevmtypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func createTestingApp(chainID string, customBaseAppOptions ...func(*baseapp.BaseApp)) *exampleapp.SILCD {
	// Create evmos app
	db := dbm.NewMemDB()
...
func setDefaultStakingGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams StakingCustomGenesisState) cosmosevmtypes.GenesisState {
	// Set staking params
...
func setDefaultBankGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams BankCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultSlashingGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams SlashingCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setBankGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func setDefaultAuthGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, genAccs []authtypes.GenesisAccount) cosmosevmtypes.GenesisState {
...
func setAuthGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, customGenesis interface{}) (cosmosevmtypes.GenesisState, error) {
...
func setDefaultGovGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams GovCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultFeeMarketGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultMintGenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState, overwriteParams MintCustomGenesisState) cosmosevmtypes.GenesisState {
...
func setDefaultErc20GenesisState(cosmosEVMApp *exampleapp.SILCD, genesisState cosmosevmtypes.GenesisState) cosmosevmtypes.GenesisState {
...
func newDefaultGenesisState(cosmosEVMApp *exampleapp.SILCD, params defaultGenesisParams) cosmosevmtypes.GenesisState {
...
func customizeGenesis(cosmosEVMApp *exampleapp.SILCD, customGen CustomGenesisState, genesisState cosmosevmtypes.GenesisState) (cosmosevmtypes.GenesisState, error) {
	var err error
