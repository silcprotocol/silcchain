...
func (s *PrecompileTestSuite) TestNameSymbol() {
	...
	testcases := []struct {
		name        string
		denom       string
		malleate    func(sdk.Context, *app.SILCD)
		expPass     bool
		errContains string
		expName     string
		expSymbol   string
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.SILCD) {
...
func (s *PrecompileTestSuite) TestTotalSupply() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.SILCD, *big.Int)
		expPass     bool
		errContains string
		expTotal    *big.Int
	}{
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, app *app.SILCD, amount *big.Int) {
				// NOTE: we mint some coins to the inflation module address to be able to set denom metadata
...
func (s *PrecompileTestSuite) TestBalanceOf() {
	...
	testcases := []struct {
		name        string
		malleate    func(sdk.Context, *app.SILCD, *big.Int) []interface{}
		expPass     bool
		errContains string
		expBalance  *big.Int
	}{
		{
			...
			malleate: func(_ sdk.Context, _ *app.SILCD, _ *big.Int) []interface{} {
				return []interface{}{}
			},
		...
		{
			name: "pass - some coins",
			malleate: func(ctx sdk.Context, app *app.SILCD, amount *big.Int) []interface{} {
...
func (s *PrecompileTestSuite) TestAllowance() {
	...
	testcases := []struct {
		...
		},
		{
			...
			malleate: func(_ sdk.Context, _ *app.SILCD, amount *big.Int) []interface{} {
				granterIdx := 0
				granteeIdx := 1
